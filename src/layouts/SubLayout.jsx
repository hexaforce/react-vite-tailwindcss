        ...
        <Popover.Group className='hidden lg:flex lg:gap-x-12'>
          ...
          {navigation.map((item) => (
            <Link
              ...
              //className={classNames(item.path === pathname ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'rounded-md px-3 py-2 text-sm font-medium')} aria-current={item.current ? 'page' : undefined}
            >
              {item.name}
            </Link>
          ))}
