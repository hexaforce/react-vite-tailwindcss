...
function PointFormInput({ setOpenPointForm }) {
...
export default function PointForm({ openPointForm, setOpenPointForm }) {
  return (
                ...
                <Dialog.Panel className='pointer-events-auto relative w-screen max-w-md'>
                  ...
                  <div className='flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl'>
                    <div className='px-4 sm:px-6'>
                      <Dialog.Title className='text-base font-semibold leading-6 text-gray-900'>ポイントを作成</Dialog.Title>
                    </div>
                    <div className='relative mt-6 flex-1 px-4 sm:px-6'>
                      <PointFormInput setOpenPointForm={setOpenPointForm} />
                    </div>
                  </div>
                </Dialog.Panel>
              </Transition.Child>
